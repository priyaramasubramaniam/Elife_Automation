...
public class CForgotPasswordPage {

      private static CForgotPasswordPage CForgotPasswordInstance;

      public CForgotPasswordPage(){}

      public static CForgotPasswordPage getInstance()
      {
            if(CForgotPasswordInstance == null)
            {
                  CForgotPasswordInstance = new CForgotPasswordPage();
            }
            return CForgotPasswordInstance;
      }
